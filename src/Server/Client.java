...
public class Client extends MFrame 
implements ActionListener, Runnable {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==bt1/*connect*/) {
			...
			try {
				FileWriter fw = 
						new FileWriter("ch15/"+millis+".txt");
				fw.write(str);
				fw.close();
				new SaveMsg(this);
			} catch (Exception e2) {
	...
	class Message extends Frame implements ActionListener {
		...
		public Message(Client ct2, String mode) {
			setTitle("쪽지보내기");
			this.ct2 = ct2;
			this.mode = mode;
